 ...
 */
class MovieChangesChangesItems
{
    #[SerializedName('id')]
    ...
    private ?MovieChangesChangesItemsValue $value = null;
    ...
    public function getValue(): ?MovieChangesChangesItemsValue
    {
        return $this->value;
    }

    public function setValue(?MovieChangesChangesItemsValue $value): self
    {
        $this->value = $value;
