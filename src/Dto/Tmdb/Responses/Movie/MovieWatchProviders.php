...
class MovieWatchProviders
{
    ...
    private ?MovieWatchProvidersResults $results = null;
    ...
    public function getResults(): ?MovieWatchProvidersResults
    {
        return $this->results;
    }

    public function setResults(?MovieWatchProvidersResults $results): self
    {
