 ...
 */
class TvEpisodeTranslationsTranslations
{
    ...
    #[SerializedName('data')]
    private ?TvEpisodeTranslationsTranslationsData $data = null;
    ...
    public function getData(): ?TvEpisodeTranslationsTranslationsData
    {
        return $this->data;
    }

    public function setData(?TvEpisodeTranslationsTranslationsData $data): self
    {
        $this->data = $data;
