 ...
 */
class TvSeriesTranslationsTranslations
{
    ...
    #[SerializedName('data')]
    private ?TvSeriesTranslationsTranslationsData $data = null;
    ...
    public function getData(): ?TvSeriesTranslationsTranslationsData
    {
        return $this->data;
    }

    public function setData(?TvSeriesTranslationsTranslationsData $data): self
    {
        $this->data = $data;
