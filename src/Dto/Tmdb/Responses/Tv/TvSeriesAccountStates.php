...
class TvSeriesAccountStates
{
    ...
    private ?TvSeriesAccountStatesRated $rated = null;
    ...
    public function getRated(): ?TvSeriesAccountStatesRated
    {
        return $this->rated;
    }

    public function setRated(?TvSeriesAccountStatesRated $rated): self
    {
        $this->rated = $rated;
