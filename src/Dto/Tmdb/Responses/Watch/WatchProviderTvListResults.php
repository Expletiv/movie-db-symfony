 ...
 */
class WatchProviderTvListResults
{
    #[SerializedName('display_priorities')]
    private ?WatchProviderTvListResultsDisplayPriorities $displayPriorities = null;
    ...
    public function getDisplayPriorities(): ?WatchProviderTvListResultsDisplayPriorities
    {
        return $this->displayPriorities;
    }

    public function setDisplayPriorities(?WatchProviderTvListResultsDisplayPriorities $displayPriorities): self
    {
