 ...
 */
class TranslationsTranslations
{
    ...
    #[SerializedName('data')]
    private ?TranslationsTranslationsData $data = null;
    ...
    public function getData(): ?TranslationsTranslationsData
    {
        return $this->data;
    }

    public function setData(?TranslationsTranslationsData $data): self
    {
        $this->data = $data;
